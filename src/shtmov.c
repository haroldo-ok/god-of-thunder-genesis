...
// shtmov.c - Shot / projectile movement functions
//
...
//===========================================================================
//===========================================================================
s16 shot_movement_none(ACTOR *actr);
s16 shot_movement_one(ACTOR *actr);
s16 shot_movement_two(ACTOR *actr);
s16 shot_movement_three(ACTOR *actr);
s16 shot_movement_four(ACTOR *actr);
s16 shot_movement_five(ACTOR *actr);
s16 shot_movement_six(ACTOR *actr);
s16 shot_movement_seven(ACTOR *actr);
s16 shot_movement_eight(ACTOR *actr);
s16 shot_movement_nine(ACTOR *actr);
s16 shot_movement_ten(ACTOR *actr);
s16 shot_movement_eleven(ACTOR *actr);
//s16 shot_movement_twelve(ACTOR *actr);

s16 (*shot_movement_func[]) (ACTOR *actr) =
    {
      shot_movement_none,
      shot_movement_one,
      shot_movement_two,
...
//===========================================================================
s16 shot_movement_none(ACTOR *actr){   //boss - snake
...
//===========================================================================
s16 shot_movement_three(ACTOR *actr){       //serpent fire
s16 d;
...
//===========================================================================
s16 shot_movement_four(ACTOR *actr){          //wraith balls
s16 x1,y1,xd,yd,d;
...
//===========================================================================
s16 shot_movement_five(ACTOR *actr){   //no move, frame cycle
...
//===========================================================================
s16 shot_movement_six(ACTOR *actr){   //wraith spots
...
#define IV 100
#define IC 50
s16 shot_movement_seven(ACTOR *actr){   //skull drop
...
//===========================================================================
s16 shot_movement_eight(ACTOR *actr){   //skull bounce
s16 x,y;
...
//===========================================================================
s16 shot_movement_nine(ACTOR *actr){   //skull explode
...
//===========================================================================
s16 shot_movement_ten(ACTOR *actr){  //skull - stalagtite
s16 f;
...
void calc_angle(s16 x1,s16 y1,s16 x2,s16 y2,ACTOR *actr){
...
//===========================================================================
s16 shot_movement_eleven(ACTOR *actr){  //angle throw
s16 x1,y1;
