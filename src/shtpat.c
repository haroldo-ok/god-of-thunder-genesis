...
// shtpat.c - Shot pattern functions (when/how enemies fire)
//
// Ported from 1_shtpat.c — pure logic, no changes needed beyond int→s16.
...
//===========================================================================
//===========================================================================
s16 shot_pattern_none(ACTOR *actr);
s16 shot_pattern_one(ACTOR *actr);
s16 shot_pattern_two(ACTOR *actr);
s16 shot_pattern_three(ACTOR *actr);
s16 shot_pattern_four(ACTOR *actr);
s16 shot_pattern_five(ACTOR *actr);
s16 shot_pattern_six(ACTOR *actr);
s16 shot_pattern_seven(ACTOR *actr);
s16 shot_pattern_eight(ACTOR *actr);

s16 (*shot_pattern_func[]) (ACTOR *actr) =
    { shot_pattern_none,
      shot_pattern_one,
      shot_pattern_two,
      shot_pattern_three,
...
//===========================================================================
s16 shot_pattern_none(ACTOR *actr){   //no shooting

actr=actr;
return 0;
}
//===========================================================================
s16 shot_pattern_one(ACTOR *actr){   //uni-directional seek
...
//===========================================================================
s16 shot_pattern_two(ACTOR *actr){   //omni directional
...
//===========================================================================
s16 shot_pattern_three(ACTOR *actr){   //uni directional (backwards)
s16 ld;
...
//===========================================================================
s16 shot_pattern_four(ACTOR *actr){   //omni-directional not solid shot
...
//===========================================================================
s16 shot_pattern_five(ACTOR *actr){   //boss - snake
s16 num;
...
//===========================================================================
s16 shot_pattern_six(ACTOR *actr){   //4 surrounding squares
s16 pos;
...
//===========================================================================
s16 shot_pattern_seven(ACTOR *actr){   //none

actr=actr;
return 0;
}
//===========================================================================
s16 shot_pattern_eight(ACTOR *actr){   //random
