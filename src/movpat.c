...
// movpat.c - Actor movement pattern functions
//
// Ported from 1_movpat.c. Changes:
//   - int → s16 throughout
//   - far pointers removed
//   - key_flag[] → JOY_readJoypad() for Thor movement
//   - xfput / display calls use Genesis wrappers
//   - timer_cnt busy-waits → game_pause() calls
//   - PAGE2 / draw_page references → Genesis equivalents (draw_bg_tile)
...
static const s16 bomb_x[] = {0,-16,32,-32,32,-16,-16, 32,-16};
static const s16 bomb_y[] = {0,-16,16,  0,16,-32, 32,-32, 32};
static const u8  rotate_pat[] = {0,3,1,2};

extern s16 (*dialog_func[])(ACTOR *actr);
...
s16 movement_zero(ACTOR *actr);
s16 movement_one(ACTOR *actr);
s16 movement_two(ACTOR *actr);
s16 movement_three(ACTOR *actr);
s16 movement_four(ACTOR *actr);
s16 movement_five(ACTOR *actr);
s16 movement_six(ACTOR *actr);
s16 movement_seven(ACTOR *actr);
s16 movement_eight(ACTOR *actr);
s16 movement_nine(ACTOR *actr);
s16 movement_ten(ACTOR *actr);
s16 movement_eleven(ACTOR *actr);
s16 movement_twelve(ACTOR *actr);
s16 movement_thirteen(ACTOR *actr);
s16 movement_fourteen(ACTOR *actr);
s16 movement_fifteen(ACTOR *actr);
s16 movement_sixteen(ACTOR *actr);
s16 movement_seventeen(ACTOR *actr);
s16 movement_eighteen(ACTOR *actr);
s16 movement_nineteen(ACTOR *actr);
s16 movement_twenty(ACTOR *actr);
s16 movement_twentyone(ACTOR *actr);
s16 movement_twentytwo(ACTOR *actr);
s16 movement_twentythree(ACTOR *actr);
s16 movement_twentyfour(ACTOR *actr);
s16 movement_twentyfive(ACTOR *actr);
s16 movement_twentysix(ACTOR *actr);
s16 movement_twentyseven(ACTOR *actr);
s16 movement_twentyeight(ACTOR *actr);
s16 movement_twentynine(ACTOR *actr);
s16 movement_thirty(ACTOR *actr);
s16 movement_thirtyone(ACTOR *actr);
s16 movement_thirtytwo(ACTOR *actr);
s16 movement_thirtythree(ACTOR *actr);
s16 movement_thirtyfour(ACTOR *actr);
s16 movement_thirtyfive(ACTOR *actr);
s16 movement_thirtysix(ACTOR *actr);
s16 movement_thirtyseven(ACTOR *actr);
s16 movement_thirtyeight(ACTOR *actr);
s16 movement_thirtynine(ACTOR *actr);
s16 movement_forty(ACTOR *actr);
s16 special_movement_one(ACTOR *actr);
s16 special_movement_two(ACTOR *actr);
s16 special_movement_three(ACTOR *actr);
s16 special_movement_four(ACTOR *actr);
s16 special_movement_five(ACTOR *actr);
s16 special_movement_six(ACTOR *actr);
s16 special_movement_seven(ACTOR *actr);
s16 special_movement_eight(ACTOR *actr);
s16 special_movement_nine(ACTOR *actr);
s16 special_movement_ten(ACTOR *actr);
...
s16 (*special_movement_func[]) (ACTOR *actr) =
    { NULL,
...
//==========================================================================
s16 check_move0(s16 x,s16 y, ACTOR *actr){   //check thor move
s16 x1,x2,y1,y2;
s16 x3,x4,y3,y4;
s16 i,ti;
ACTOR *act;
   ...
   if(overlap(x1,y1,x2,y2,x3,y3,x4,y4)){
     if(act->func_num>0){ //255=explosion
       ...
       if(act->solid<2){
         ...
         if(!hammer->used && (JOY_readJoypad(JOY_1) & BUTTON_A))
...
//==========================================================================
s16 check_move1(s16 x,s16 y, ACTOR *actr){   //check hammer move
s16  x1,x2,y1,y2,i;
s16  x3,y3,x4,y4;
s16  icn,f;
char icn1,icn2,icn3,icn4;
...
//==========================================================================
s16 check_move2(s16 x,s16 y, ACTOR *actr){   //check enemy move
s16 x1,x2,y1,y2,i;
s16 x3,y3,x4,y4;
s16 icn;
char icn1,icn2,icn3,icn4;
...
//==========================================================================
s16 check_move4(s16 x,s16 y, ACTOR *actr){   //flying enemies
...
#define THOR_PAD1 2
#define THOR_PAD2 4
s16  check_thor_move(s16 x,s16 y, ACTOR *actr){
...
//===========================================================================
s16 movement_zero(ACTOR *actr){       //player control
s16 d,x,y,od;
d=actr->dir;
od=d;
...
if((JOY_readJoypad(JOY_1) & BUTTON_A)) thor_shoots();
if((JOY_readJoypad(JOY_1) & BUTTON_C)) select_item();
...
if((JOY_readJoypad(JOY_1) & BUTTON_UP) && (JOY_readJoypad(JOY_1) & BUTTON_LEFT)){
    d=2;
    actr->dir=d;
    diag=1;
    diag_flag=1;
...
else if((JOY_readJoypad(JOY_1) & BUTTON_UP) && (JOY_readJoypad(JOY_1) & BUTTON_RIGHT)){
    d=3;
    actr->dir=d;
    diag=2;
    diag_flag=1;
...
else if((JOY_readJoypad(JOY_1) & BUTTON_DOWN) && (JOY_readJoypad(JOY_1) & BUTTON_LEFT)){
    d=2;
    actr->dir=d;
    diag=4;
    diag_flag=1;
...
else if((JOY_readJoypad(JOY_1) & BUTTON_DOWN) && (JOY_readJoypad(JOY_1) & BUTTON_RIGHT)){
    d=3;
    actr->dir=d;
    diag=3;
    diag_flag=1;
...
//==========================================================================
s16 check_special_move1(s16 x,s16 y, ACTOR *actr){
s16 x1,x2,y1,y2,i;
s16 x3,y3,x4,y4;
s16 icn;
char icn1,icn2,icn3,icn4;
...
//*==========================================================================
//===========================================================================
s16 special_movement_one(ACTOR *actr){   //block
s16 d,x1,y1,sd;
...
//===========================================================================
s16 special_movement_two(ACTOR *actr){   //angle
s16 x1,y1,x2,y2,i;
s16 x3,y3,x4,y4;
ACTOR *act;
...
if(!actr->func_pass){
  if(thor->health<150){
    if(!sound_playing()) play_sound(ANGEL_SND,0);
    thor->health+=1;
    display_health();
  }
}
...
//===========================================================================
s16 special_movement_three(ACTOR *actr){  //yellow globe
long lind;
...
//===========================================================================
s16 special_movement_four(ACTOR *actr){   //peg switch
...
//===========================================================================
s16 special_movement_five(ACTOR *actr){    //boulder roll
s16 d;
...
//*==========================================================================
//===========================================================================
s16 movement_one(ACTOR *actr){    //no movement - frame cycle

next_frame(actr);
return actr->dir;
}
//===========================================================================
s16 movement_two(ACTOR *actr){     //hammer only
s16 d,x1,y1;
...
//===========================================================================
s16 movement_three(ACTOR *actr){         //walk-bump-random turn
s16 d,x1,y1;
...
//===========================================================================
s16 movement_four(ACTOR *actr){         //simple tracking
s16 d,x1,y1,f;
...
//===========================================================================
s16 movement_six(ACTOR *actr){   //explosion only

if(actr->num_shots>0){
  actr->next++;
  if(actr->next>2){
    actr->next=0;
    if(boss_dead) play_sound(EXPLODE_SND,0);
  }
  actr->num_shots--;
}
else{
...
//===========================================================================
s16 movement_seven(ACTOR *actr){         //walk-bump-random turn (pause also)
...
//==========================================================================
s16 movement_eight(ACTOR *actr){         //follow thor
...
//===========================================================================
s16 movement_nine(ACTOR *actr){         //4-way straight (random length) change
s16 d,x1,y1,f;
...
//===========================================================================
s16 movement_ten(ACTOR *actr){         //vert straight (random length) change
s16 d,x1,y1,f;
...
//===========================================================================
s16 movement_eleven(ACTOR *actr){         //horz only (bats)
s16 d;
...
//===========================================================================
s16 movement_twelve(ACTOR *actr){         //horz straight until bump
s16 d;
...
//===========================================================================
s16 movement_thirteen(ACTOR *actr){         //pause-seek (mushroom)
s16 d;
...
//===========================================================================
s16 movement_fourteen(ACTOR *actr){         //move-bump-stop (boulder)
s16 d,x1,y1;
...
//===========================================================================
s16 movement_fifteen(ACTOR *actr){    //no movement - no frame cycle

return actr->dir;
}
//===========================================================================
s16 movement_sixteen(ACTOR *actr){     //tornado 1
s16 d,x1,y1;
...
//===========================================================================
s16 movement_seventeen(ACTOR *actr){         //tornado 2
s16 d;
...
//===========================================================================
s16 movement_eighteen(ACTOR *actr){    //no movement - frame cycle
s16 d;
...
//===========================================================================
s16 movement_nineteen(ACTOR *actr){    //no movement - frame cycle

return movement_seven(actr);
}
//===========================================================================
s16 movement_twenty(ACTOR *actr){    //boss - snake

return boss1_movement(actr);
}
//===========================================================================
s16 movement_twentyone(ACTOR *actr){    //no movement - frame cycle

return movement_three(actr);
}
//===========================================================================
s16 movement_twentytwo(ACTOR *actr){    //spear
s16 d;
...
//===========================================================================
s16 movement_twentythree(ACTOR *actr){    //spinball counter-clockwise
s16 d;
...
//===========================================================================
s16 movement_twentyfour(ACTOR *actr){    //spinball  clockwise
s16 d;
...
//===========================================================================
s16 movement_twentyfive(ACTOR *actr){         //acid puddle
s16 i,ret;
...
//===========================================================================
s16 movement_twentynine(ACTOR *actr){  //horz or vert (pass_val)
...
//===========================================================================
s16 movement_thirty(ACTOR *actr){         //vert straight
s16 d,x1,y1;
...
//===========================================================================
s16 movement_thirtyone(ACTOR *actr){         //drop (stalagtite)
s16 d,x1,y1,cx,cy,ty,i;
...
//===========================================================================
s16 movement_thirtytwo(ACTOR *actr){      //unused

actr=actr;
return 0;
}
//===========================================================================
s16 movement_thirtythree(ACTOR *actr){    //unused

actr=actr;
return 0;
}
//===========================================================================
s16 movement_thirtyfour(ACTOR *actr){    //unused

actr=actr;
return 0;
}
//===========================================================================
s16 movement_thirtyfive(ACTOR *actr){    //gun (single)

actr->next=actr->last_dir;
return actr->dir;
}
//===========================================================================
s16 movement_thirtysix(ACTOR *actr){    //acid drop
...
//===========================================================================
s16 movement_thirtynine(ACTOR *actr){    //troll 1
...
//===========================================================================
s16 movement_forty(ACTOR *actr){    //troll 2
s16 x1,x2,a,d,f;
...
s16 (*movement_func[])(ACTOR *actr) = {
    movement_zero, movement_one, movement_two, movement_three, movement_four,
    movement_five, movement_six, movement_seven, movement_eight, movement_nine,
    movement_ten, movement_eleven, movement_twelve, movement_thirteen, movement_fourteen,
    movement_fifteen, movement_sixteen, movement_seventeen, movement_eighteen,
    movement_nineteen, movement_twenty, movement_twentyone, movement_twentytwo,
    movement_twentythree, movement_twentyfour, movement_twentyfive, movement_twentysix,
    movement_twentyseven, movement_twentyeight, movement_twentynine, movement_thirty,
    movement_thirtyone, movement_thirtytwo, movement_thirtythree, movement_thirtyfour,
    movement_thirtyfive, movement_thirtysix, movement_thirtyseven, movement_thirtyeight,
    movement_thirtynine, movement_forty,
};
